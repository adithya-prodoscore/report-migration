"""Pydantic schemas for the Monthly KPI Report Tier 4 endpoint.
...
class MonthlyKpiReportTier4Response(BaseModel):
    """Top-level response schema for GET /api/v1/monthly-kpi-report-tier-4.

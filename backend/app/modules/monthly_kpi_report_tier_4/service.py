"""Service layer for Monthly KPI Report Tier 4.
...
from app.modules.monthly_kpi_report_tier_4.repository import MonthlyKpiReportTier4Repository
...
class MonthlyKpiReportTier4Service:
    """Orchestrates the full Monthly KPI Report Tier 4 pipeline."""

    def __init__(self):
        self.repository = MonthlyKpiReportTier4Repository()

"""Repository layer for Monthly KPI Report Tier 4.
...
SQL queries are ported verbatim from monthly_kpi_report.py (DS report Tier 4).
"""
...
# --- 4a. Canonical activity query (production main_table CTE, trimmed) -----------
...
class MonthlyKpiReportTier4Repository:
    """Data access layer for Monthly KPI Report Tier 4.

"""Monthly KPI Report Tier 3 module.

Provides FastAPI endpoint and supporting services for the Monthly KPI Report Tier 3,
...
Entry point: router (FastAPI APIRouter)
  - GET /api/v1/monthly-kpi-report-tier-3?domain_id=9&start_date=2026-05-01&end_date=2026-05-29
"""

from app.modules.monthly_kpi_report_tier_3.router import router

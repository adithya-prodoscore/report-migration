"""Pydantic schemas for the Monthly KPI Report Tier 5 endpoint.
...
class TriageEmployeeRecord(BaseModel):
    ...
    roleAvgTimeMin: Optional[int] = Field(None, description="Role avg active time in minutes (TOP_PERFORMERS)")
...
class MonthlyKpiReportTier5Response(BaseModel):
    """Top-level response schema for GET /api/v1/monthly-kpi-report-tier-5.

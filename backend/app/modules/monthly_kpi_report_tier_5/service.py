"""Service layer for Monthly KPI Report Tier 5.

Implements the full production triage pipeline from monthly_kpi_report.py
(DS report Tier 5, structurally identical to Tier 4):
...
from app.modules.monthly_kpi_report_tier_5.repository import MonthlyKpiReportTier5Repository
...
class MonthlyKpiReportTier5Service:
    """Orchestrates the full Monthly KPI Report Tier 5 pipeline."""

    def __init__(self):
        self.repository = MonthlyKpiReportTier5Repository()

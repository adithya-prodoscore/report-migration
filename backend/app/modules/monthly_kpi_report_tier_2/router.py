...
from app.modules.monthly_kpi_report_tier_2.service import MonthlyKpiReportTier2Service
from app.modules.monthly_kpi_report_tier_2.schemas import MonthlyKpiReportTier2Response

router = APIRouter(prefix="/api/v1", tags=["Monthly KPI Report Tier 2"])
service = MonthlyKpiReportTier2Service()


@router.get("/monthly-kpi-report-tier-2", response_model=MonthlyKpiReportTier2Response)
def get_monthly_kpi_report_tier_2(
    ...
    """
    Get complete Monthly KPI Report Tier 2 with the production 6-gate working-day
    logic applied.

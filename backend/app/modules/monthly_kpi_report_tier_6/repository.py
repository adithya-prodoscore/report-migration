"""Repository layer for Monthly KPI Report Tier 6.
...
SQL queries are ported verbatim from monthly_kpi_report.py (DS report Tier 6),
which is structurally identical to Tier 5.
"""
...
class MonthlyKpiReportTier6Repository:
    """Data access layer for Monthly KPI Report Tier 6.

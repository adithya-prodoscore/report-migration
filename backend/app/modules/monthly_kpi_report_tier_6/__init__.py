"""Monthly KPI Report Tier 6 module.

Provides FastAPI endpoint and supporting services for the Monthly KPI Report Tier 6,
...
This tier is structurally identical to Tier 5 but registered as an independent
module so it can evolve independently.

Entry point: router (FastAPI APIRouter)
  - GET /api/v1/monthly-kpi-report-tier-6?domain_id=9&start_date=2026-05-01&end_date=2026-05-29
"""

from app.modules.monthly_kpi_report_tier_6.router import router

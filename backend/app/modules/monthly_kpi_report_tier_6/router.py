...
from app.modules.monthly_kpi_report_tier_6.service import MonthlyKpiReportTier6Service
from app.modules.monthly_kpi_report_tier_6.schemas import MonthlyKpiReportTier6Response

router = APIRouter(prefix="/api/v1", tags=["Monthly KPI Report Tier 6"])
service = MonthlyKpiReportTier6Service()


@router.get("/monthly-kpi-report-tier-6", response_model=MonthlyKpiReportTier6Response)
def get_monthly_kpi_report_tier_6(
    ...
    """
    Get complete Monthly KPI Report Tier 6 with the production 6-gate working-day

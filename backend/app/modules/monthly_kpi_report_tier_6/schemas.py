"""Pydantic schemas for the Monthly KPI Report Tier 6 endpoint.
...
class MonthlyKpiReportTier6Response(BaseModel):
    """Top-level response schema for GET /api/v1/monthly-kpi-report-tier-6.

...
// ---------------------------------------------------------------------------
// TypeScript types — mirroring the backend MonthlyKpiReportTier3Response
// ---------------------------------------------------------------------------
...
export interface MonthlyKpiReportTier3Data {
...
async function fetchMonthlyKpiReportTier3(
  domainId: string,
  startDate: string,
  endDate: string,
): Promise<MonthlyKpiReportTier3Data> {
  const base = process.env.NEXT_PUBLIC_API_URL ?? ''
  const url = `${base}/api/v1/monthly-kpi-report-tier-3?domain_id=${domainId}&start_date=${startDate}&end_date=${endDate}`
...
export function useMonthlyKpiReportTier3(
  domainId: string,
  startDate: string,
  endDate: string,
) {
  return useQuery({
    queryKey: ['monthly-kpi-report-tier-3', domainId, startDate, endDate],
    queryFn: () => fetchMonthlyKpiReportTier3(domainId, startDate, endDate),

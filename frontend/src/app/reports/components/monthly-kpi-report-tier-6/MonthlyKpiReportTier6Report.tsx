...
import { useMonthlyKpiReportTier6 } from '@/hooks/useMonthlyKpiReportTier6'
...
function ReportInner({ domainId, startDate, endDate }: ReportProps) {
  ...
  const { data, isLoading, isError, error } = useMonthlyKpiReportTier6(
    effectiveDomain,
    effectiveStart,
    effectiveEnd,
  )
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-neutral-50">
        ...
        <p className="mt-4 text-sm text-neutral-500">Loading Monthly KPI Report Tier 6…</p>
      </div>
    )
  }
...
export function MonthlyKpiReportTier6Report(props: ReportProps) {
  return (

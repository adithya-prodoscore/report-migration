...
import type { MonthlyKpiReportTier6Data, EmployeeRecord } from '@/hooks/useMonthlyKpiReportTier6'
...
interface EmployeeDataTableProps {
  ...
  toolMeta: MonthlyKpiReportTier6Data['TOOL_META']
  search: string
}
...
export function EmployeeDataTable({ employees, toolMeta, search }: EmployeeDataTableProps) {
  ...
  function downloadCsv() {
    ...
    a.href = url
    a.download = 'monthly_kpi_report_tier6.csv'
    a.click()

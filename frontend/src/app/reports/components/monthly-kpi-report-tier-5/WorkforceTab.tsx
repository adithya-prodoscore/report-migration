...
import type { MonthlyKpiReportTier5Data, DailyScore } from '@/hooks/useMonthlyKpiReportTier5'
...
const DIMENSION_DAILY_MAP: Record<Dimension, keyof MonthlyKpiReportTier5Data> = {
  role: 'ROLE_DAILY',
  manager: 'MANAGER_DAILY',
  department: 'DEPARTMENT_DAILY',
}

const DIMENSION_AVGS_MAP: Record<Dimension, keyof MonthlyKpiReportTier5Data> = {
  role: 'ROLE_AVGS',
